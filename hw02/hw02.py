...
def waves(n):
    ...
    def helper(n, count, prev):
        ...
        "*** YOUR CODE HERE ***"
        if n < 10 and count %2 == 0:
            return True
        elif n < 10 and count %2 != 0:
            return False
        elif next > curr and curr < prev:
            count = count+1
...
def count_coins(total):
    ...
    def func(total,coin):
        if total<0:
            ...
            result = func(total-coin, coin)+ func(total,next_larger_coin(coin))
            return result
    return func(total,1)